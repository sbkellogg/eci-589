...
you generate ideas for independent application of network analysis. As
part of our readings, for example, you'll be introduced to a range of
questions that statistical models for network data can help answer.

## Readings

For Unit 4, you will read chapters 8 and 9 from [Social Network Analysis
