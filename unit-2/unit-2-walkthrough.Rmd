...
will be using {rtweet} package to search for and download tweets based
...
Now use let's use the `read_csv()` function to save our
...
Use the `search_tweets` function to create you own custom query for a
...
by @supovitz2017commoncore. Specifically,
