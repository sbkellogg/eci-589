...
output, or "tibble," using the `as_tibble()` function. This will allow
us to get a better look at our nodes and the measure of `degree` instead
of `local_size()` that we just created.
