...
Our *Unit 2 Case Study: Collaboration Ties over Time* introduces the
...
As noted above, before we can begin exploring our data through network
visualization and analysis, we must first restructure our data into a
formal matrix and then convert to a network class R object required by
the igraph, tidygraph, and ggraph packages.
...
2.  it will created a file in your directory that you can use to share
    ...
    below), or any other preferred means.
