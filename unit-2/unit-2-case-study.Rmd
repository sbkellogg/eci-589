...
Our Unit 2 Case Study: Collaboration Ties over Time revisits some of
excellent research by Dr. Alan Daly and centers around the impact No
Child Left Behind reform efforts on school and district leadership
networks. In this unit we move beyond visual depictions of networks
using sociograms from our previous SNA case study and learn to describe
networks using a wide range network-level measures. More specifically,
our Unit 2 case study will cover the following topics pertaining to each
data-intensive workflow process:
...
1.  **Prepare**: Prior to analysis, we'll take a look at the context
    ...
    load various R packages for network analysis.
