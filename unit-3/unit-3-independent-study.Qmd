---
title: 'Data Wrangling & Network Measures'
subtitle: "ECI 589 SNA and Education: Unit 2 Independent Study"
...
For students new to R, this week you will learn the most important data handling skills in R: how to extract values from a table, subset tables, calculate summary statistics, and derive new variables.

### Assignment

Your assignment this week is to complete the following primers located in the [Work with Data](https://posit.cloud/learn/primers/2) section on [Posit Cloud](https://posit.cloud/learn/primers):

1.  [Working with Tibbles](https://posit.cloud/learn/primers/2.1). Learn to use tibbles, the most user-friendly tabular data structure in R, as well as how to manage tidyverse packages with\... the tidyverse package.
2.  [Isolating Data with dplyr](https://posit.cloud/learn/primers/2.2). Master three simple functions for finding, and extracting, the data in your data set. Here you will learn to select variables, filter observations, and arrange values. Here, you will also meet R's pipe operator, %\>%.
3.  [Deriving Information with dplyr](https://posit.cloud/learn/primers/2.3). Data sets contain more information than they display, and this tutorial will show you how to access that information. You'll learn to derive new variables and to compute groupwise summary statistics.
