...
For this quiz you will need to navigate to the [ECI 589 SNA and Education workspace](https://posit.cloud/spaces/322769/join?access_code=ZuCVwxEaX0MeAI5aj_P1_9gnl2D9I7SjMRYk6bog), **access the Unit 3 - Independent Study R Studio project assignment, and open the unit-3-quiz.R file to use as you\'re working through this quiz.** This will allow you to type all of your code, add comments, and then save your .R script for reference as needed. In addition, some quiz items may ask you to open and manipulate a data file saved in the data folder. 
