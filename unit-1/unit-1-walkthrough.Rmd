...
As you saw from the `network` output, our dataset has 2529 edges or
ties. But how many of these are unique?

```{r}
edge_counts <- count_multiple(network)

edge_counts
```

As you can see from the output under the edges
