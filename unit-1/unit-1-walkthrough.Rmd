...
3.  **Explore**: In section 3, we calculate some basic network
    descriptives and learn how to summarize the descriptives through a
...
5.  **Communicate**: We'll learn more about communicating key findings
    next week, but for now will learn some basic components of a data
    product.
...
Based on what you know about networks and the context so far, what
subquestions or more specific research questions might ask we ask that a
social network perspective might be able to answer?
