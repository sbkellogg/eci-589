...
another. Network visualization can be used for a variety of purposes, as
illustrated by this excellent figure from Katya Ognyanova's also
excellent tutorial on [Static and Dynamic Network Visualization with
...
Fortunately, {igraph} includes a [plethora of plotting
parameters](https://kateto.net/sunbelt2019#plotting-parameters) for
improving the layout and visual design of network graphs!

#### Remove Labels

One quick fix is to simply remove the labels.
...
There are many ways to arrange actors in a sociogram, as there are many
ways to represent actors or their ties. Up to four attributes of each
actor can be layered onto the sociogram by altering the color, shape,
label, and size of the symbol.
