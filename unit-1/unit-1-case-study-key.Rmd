...
subtitle: "ECI 589: Unit 1 Case Study"
...
explore the use of models for SNA until Unit4, but recall from the
...
inference when working with relational data in Learning Unit4.
